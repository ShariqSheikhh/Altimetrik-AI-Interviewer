...
- "follow_up" — ONLY if ONE OR MORE key points are CLEARLY MISSING BUT the answer is in the right context (partially correct). Generate a natural follow-up question that specifically asks about the MISSED key points to see if the candidate knows them. CRITICAL: NEVER repeat the original question. If the candidate gives a 1-liner or partial answer, your follow-up MUST be a NEW, specific probing question focused on what they left out. Do NOT reveal the answers.
- "skip" — ONLY if the answer is COMPLETELY off-topic, out of context, or if they explicitly say they don't know. No follow-up needed.
